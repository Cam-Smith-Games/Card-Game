...
export class Character extends GameObject {
    constructor(args) {
        ...
        this.flipped = false;
        this.name = args.name;
        __classPrivateFieldSet(this, _hp, args.hp);
        __classPrivateFieldSet(this, _maxHP, args.hp);
        this.baseAP = (_a = args.baseAP) !== null && _a !== void 0 ? _a : 4;
        this.ap = this.baseAP;
        this.buffs = (_b = args.buffs) !== null && _b !== void 0 ? _b : [];
        this.deck = args.deck;
        this.drawPile = this.deck;
        this.defense = (_c = args.defense) !== null && _c !== void 0 ? _c : {};
        this.dodge = (_d = args.dodge) !== null && _d !== void 0 ? _d : 0;
        // defaulting animation
        this.animations = (_e = args.animations) !== null && _e !== void 0 ? _e : {};
        // adding shaddow
    ...
    get hp() { return __classPrivateFieldGet(this, _hp); }
    ;
    set hp(val) {
        if (val <= 0) {
        ...
        __classPrivateFieldSet(this, _hp, val);
    }
    update(deltaTime) {
    ...
    render(ctx) {
        super._render(ctx, () => {
            ...
            ctx.fillStyle = "green";
            ctx.fillRect(-this.size.x / 2, this.size.y / 2 + 4, this.size.x * (__classPrivateFieldGet(this, _hp) / __classPrivateFieldGet(this, _maxHP)), 6);
            //ctx.fillStyle = "red";
    ...
    async doTurn(battle, friends, enemies) {
        ...
        Announcement.Promise({
            ...
            pos: new Vector(battle.ctx.canvas.width / 2, battle.ctx.canvas.height / 2),
            r: 255, g: 255, b: 255,
            font: "72px Arial",
            outline: false
        });
...
_maxHP = new WeakMap(), _hp = new WeakMap();
