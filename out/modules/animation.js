...
export class SpriteAnimation {
    constructor(args) {
        ...
        this.sheet = args.sheet;
        this.frameSize = (_a = args.frameSize) !== null && _a !== void 0 ? _a : new Vector(64, 64);
        ...
        this.offset = new Vector(offset.x + ((column - 1) * this.frameSize.x), offset.y + ((row - 1) * this.frameSize.y));
    }
