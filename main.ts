...
import { PlayerCharacter, NonPlayerCharacter, CharacterArgs } from "./modules/character.js";
import { ProjectileAbility as ProjectileCard, elements, SimpleCard as SimpleCard, MeleeCard, Card } from "./modules/card.js";
...
function getContent(images : Record<string,HTMLImageElement>) {
...
function init(images : Record<string,HTMLImageElement>) {
